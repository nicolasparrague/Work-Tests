...
export default class Homepageinternallink extends OmniscriptBaseMixin(NavigationMixin(LightningElement)) {
   isMedicare = false;
   isCommercial = false;
   _productGroup;
   _preferredLanguage;
   ...
   set preferredLanguage(val) {
      this._preferredLanguage = val;
   }
   ...
   openInternallink() {
      this.externalURL = "https://attentisconsulting.com/contact/";
