...
export default class MakeChasePaymentCreditCard extends OmniscriptBaseMixin(LightningElement) {
    //iframe height
    ...
    createCase(){
        let jsonData = JSON.parse(JSON.stringify(this.omniJsonData));
        //let inputParam = { UserId: this.userIdFrame, planType: this.planTypeFrame };
        let tenant = 'Attentis';
        let inputs = {
            sClassName: "omnistudio.IntegrationProcedureService",
