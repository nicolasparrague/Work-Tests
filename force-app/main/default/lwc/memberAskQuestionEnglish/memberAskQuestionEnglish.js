...
import { OMNIDEF } from './memberAskQuestionEnglish_def.js';
import tmpl from './memberAskQuestionEnglish.html';
import tmpl_nds from './memberAskQuestionEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class memberAskQuestionEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
