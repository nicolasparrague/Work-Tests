...
import { OMNIDEF } from './memberBillingAndPaymentEnglish_def.js';
import tmpl from './memberBillingAndPaymentEnglish.html';
import tmpl_nds from './memberBillingAndPaymentEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class memberBillingAndPaymentEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
