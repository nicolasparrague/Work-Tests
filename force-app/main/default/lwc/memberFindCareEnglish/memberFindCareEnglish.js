...
import { OMNIDEF } from './memberFindCareEnglish_def.js';
import tmpl from './memberFindCareEnglish.html';
import tmpl_nds from './memberFindCareEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class memberFindCareEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
